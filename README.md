...
This repository accompanies the Chinese academic monograph **《反问题与最优传输》** by **汪文帅** and **孙建**.
...
This repository does **not** replace the book manuscript and does **not** redistribute third-party source code, datasets, trained models, model weights, or documentation. External repositories are cited as public source projects, reference implementations, or reproducibility entry points only.
...
| Chapter 7 | `chapters/ch07_ot_cyclegan/` | Chapter-level source note and self-written synthetic LDCT/SDCT-domain data-generation script. |
...
| Chapter 5 | Sinkhorn and entropic optimal transport references | — | [Cuturi (2013)](https://papers.nips.cc/paper/4927-sinkhorn-distances-lightspeed-computation-of-optimal-transport); [Feydy et al. (2019)](https://proceedings.mlr.press/v89/feydy19a.html); [Peyré and Cuturi (2019)](https://doi.org/10.1561/2200000073) |
...
| Chapter 10 | Flower; pyABC | [`mehrsapo/Flower`](https://github.com/mehrsapo/Flower); [`ICB-DCM/pyABC`](https://github.com/ICB-DCM/pyABC) | [Pourya et al. (2026)](https://openreview.net/forum?id=QGd34p02mI); [Schälte et al. (2022)](https://doi.org/10.21105/joss.04304) |
